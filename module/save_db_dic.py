...
class Database(object):
    ...
    def __init__(self, folder_path="../results", database_name='results'):
...
class BackUp(object):
    ...
    def __init__(self, results_folder="../results", database_name='results', table_name='data'):

        self.db = Database(folder_path=results_folder, database_name=database_name)
