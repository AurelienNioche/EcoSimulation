...
cdef class Economy(object):
    ...
    cdef:
        ...
        cnp.ndarray type, value_option0, value_option1, probability_of_choosing_option0, random_number, choice, \
            place, placement, decision_array, decision, \
...
############################################################
    ...
    cdef update_estimations(self):
        ...
        cdef:
            int i
            cnp.ndarray informers_choices, informers_results, informers_averages, estimations, new_estimations
    ...
    cdef tuple info_select_informers(self, int i):
        ...
        cdef:
            int i_type, i_choice
            cnp.ndarray agents, informers, relative_types, relative_choices, \
                informers_types, informers_results, informers_choices
            list agents_list
    ...
    cdef cnp.ndarray info_compute_information(self, int i, cnp.ndarray informers_choices,
                                              cnp.ndarray informers_results):

        cdef:
            int exchange_type
            cnp.ndarray averages, bool_exchange
    ...
    cdef cnp.ndarray info_integrate_information(self, int i, cnp.ndarray informers_averages, cnp.ndarray estimations):

        cdef:
            int i_choice, exchange_type
            float others_opinion
            cnp.ndarray my_opinion
...
cdef class SimulationRunner(object):

    cdef:
        int t_max, t
        Economy eco
        cnp.ndarray indirect_exchanges, direct_exchanges
    ...
    cdef make_some_stats(self):

        cdef:
            int i
            cnp.ndarray idx , ind1, ind2, direct
